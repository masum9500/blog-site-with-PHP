...
<body>
	<div class="headersection templete clear">
			...
			<div class="logo">
				...
				?>
				<a href="index.php"><img src="admin/<?php echo $result['logo'];?>" alt="Logo"/>
				<a href="index.php" style="text-decoration: none;"><h2><?php echo $result['title'];?></h2></a>
				<a href="index.php" style="text-decoration: none;"><p><?php echo $result['slogan'];?></p></a>
				<?php } }?>
			</div>
